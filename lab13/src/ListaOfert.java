...
public class ListaOfert {
    ...
    public ListaOfert() {
        ...
        this.listaOfert.add(new Dom("dluga",119,"Gdansk","88-201",95,420420.99, LocalDate.parse("2022-02-20"),300));
        this.listaOfert.add(new Dom("wysockiego",32,"Gdansk","88-201",110,400000.99, LocalDate.parse("2024-02-10"),300));
        this.listaOfert.add(new Mieszkanie("belgraua",175,"Gdansk","88-201",22,4500.99, LocalDate.parse("2023-07-24"),53,7));
